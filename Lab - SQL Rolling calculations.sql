...
select * from customer_activity; -- This gives us all the customers per month
...
select * from monthly_active_customers; -- This gives us the amount of those customers grouped by month and year
